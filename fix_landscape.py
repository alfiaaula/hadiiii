...
"""
with open('update_css.py', 'w', encoding='utf-8') as f:
    f.write(f'''
...
# Add wrapper div to the presentation slide to support container queries
if 'class="presentation-wrapper"' not in html:
    html = html.replace('<div class="presentation-slide">', '<div class="presentation-wrapper">\n                <div class="presentation-slide">')
    html = html.replace('</div>\n            \n            <!-- Contextual back button -->', '</div>\n            </div>\n            \n            <!-- Contextual back button -->')
